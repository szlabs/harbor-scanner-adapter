...
// CISLevel : Check level for CIS benchmarks. * `Fatal` -  Be practical and prudent * `Warn`- Be practical and prudent, but limited uses (even if official images) * `Info` - May negatively inhibit the utility or performance * `Skip` - Not found target files * `Pass` - Not found any problems
type CISLevel string

// List of CISLevel
const (
	FATAL CISLevel = "Fatal"
	WARN  CISLevel = "Warn"
	INFO  CISLevel = "Info"
	SKIP  CISLevel = "Skip"
	PASS  CISLevel = "Pass"
